...
import { NavigationComponent } from "../../shared/components/navigation/navigation.components";
          ...
          <div class="bg-white shadow rounded-lg">
            ...
            <div class="p-6">
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <a
                  routerLink="/accounts"
                  class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-3 rounded-lg flex items-center justify-center gap-2 transition-colors"
                >
                  <svg
                    class="w-5 h-5"
                    fill="none"
